...
const Hero = () => {
  ...
  return (
    <div className="bg-[#F2F0F1] h-full p-10 md:p-20 overflow-hidden">
      <div className="parent grid grid-cols-1 md:grid-cols-2">
        <div className="left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-start py-12">
        ...
        <div className="right relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/images/header-res-homepage.png')] md:bg-[url('/images/header-homepage.png')]">
